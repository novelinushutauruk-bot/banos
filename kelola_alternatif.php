...
$query = mysqli_query($conn, "SELECT * FROM riwayat_penilaian ORDER BY id DESC");
...
<head>
<meta charset="UTF-8">
<title>Kelola Nilai Alternatif</title>
...
td:nth-child(1), td:nth-child(3), td:nth-child(4), td:nth-child(5), td:nth-child(6), td:nth-child(7){text-align:center;}
...
<div class="main">
    ...
    <div class="content">
        <h2>Kelola Nilai Alternatif</h2>
        <a href="tambah_alternatif.php" class="add-btn">+ Tambah Alternatif</a>
        ...
        <table>
            ...
            <?php if(mysqli_num_rows($query) > 0): ?>
                ...
                <tr>
                    ...
                    <td><?= $row['aset'] ?></td>
                    <td class="action">
                        <a href="edit_alternatif.php?id=<?= $row['id'] ?>" class="edit">Edit</a>
                        <a href="hapus_alternatif.php?id=<?= $row['id'] ?>" class="delete" onclick="return confirm('Yakin hapus data ini?')">Hapus</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            <?php else: ?>
                <tr><td colspan="8" style="text-align:center;">Data belum tersedia</td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </div>
